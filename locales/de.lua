Locales ['de'] = {
  -- weed
  ['weed_pickupprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um die ~g~Cannabis~s~ Pflanze zu ernten.',
  ['weed_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Cannabis~s~.',
  ['weed_processprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um ~g~Prozess Cannabis~s~ zu starten.',
  ['weed_processingstarted'] = 'Verarbeitung von ~g~Cannabis~s~ zu ~g~Marihuana~s~...',
  ['weed_processingfull'] = 'Bearbeitung ~r~abgebrochen~s~ wegen vollem Inventar!',
  ['weed_processingenough'] = 'Sie müssen ~b2x~s~ ~g~Cannabis~s~ haben, um verarbeiten zu können.',
  ['weed_processed'] = 'Sie haben ~b~2x~s~ ~g~Cannabis~s~ zu ~b~1x~s~ ~g~Marihuana~s~ verarbeitet',
  ['weed_processingtoofar'] = 'Die Verarbeitung wurde abgebrochen, weil Sie den Bereich verlassen haben.',
  
  -- meth
  ['HydrochloricAcid_pickupprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um das ~g~Salzsäure~s~ Fass aufzunehmen.',
  ['SulfuricAcid_pickupprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um das ~g~Schwefelsäure~s~ Fass aufzunehmen.',
  ['SodiumHydroxide_pickupprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um das ~g~Natriumhydroxid~s~ Fass aufzunehmen.',
  ['HydrochloricAcid_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Salzsäure~s~.',
  ['SulfuricAcid_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Schwefelsäure~s~.',
  ['sodium_hydroxide_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Natriumhydroxid~s~.',
  ['meth_processprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um mit ~g~Meth Prozess~s~ zu beginnen.',
  ['meth_processingstarted'] = 'Verarbeitung ~g~Meth~s~...',
  ['meth_processingfull'] = 'Bearbeitung ~r~abgebrochen~s~ wegen vollem Inventar!',
  ['meth_processingenough'] = 'Sie müssen ~b~1x~s~ von allem haben, um zu verarbeiten.',
  ['meth_processed'] = 'you\'ve processed ~b~1x~s~ ~g~Meth~s~',
  ['meth_processingtoofar'] = 'Die Verarbeitung wurde abgebrochen, weil Sie den Bereich verlassen haben.',
  
  -- coke
  ['coke_pickupprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um die ~g~Coca~s~ Pflanze zu ernten.',
  ['coke_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Kokablatt~s~.',
  ['coke_processprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um ~g~Coca verarbeitung~s~ zu starten.',
  ['coke_processingstarted'] = 'Verarbeitung ~g~Coca~s~...',
  ['coke_processingfull'] = 'Bearbeitung ~ r ~ abgebrochen ~ s ~ wegen vollem Inventar!',
  ['coke_processingenough'] = 'Sie müssen ~b~3x~s~ ~g~Coca-Blatt ~s~ haben, um verarbeiten zu können.',
  ...
  ['heroin_inventoryfull'] = 'Sie haben keinen Inventarplatz mehr für ~g~Heroin~s~.',
  ['heroin_processprompt'] = 'Drücken sie ~INPUT_CONTEXT~ um die ~g~Heroin verarbeitung~s~ zu starten.',
  ['heroin_processingstarted'] = 'Verarbeitung von ~g~Mohnharz~s~ zu ~g~Heroin~s~...',
  ['heroin_processingfull'] = 'Bearbeitung ~r~abgebrochen~s~ wegen vollem Inventar!',
  ...
  ['license_no'] = 'Nein',
  ['license_bought'] = 'Sie haben die ~b~%s~s~ für ~r~$%s~s~ gekauft',
  ['license_bought_fail'] = 'Sie können sich keine ~b~%s~s~ leisten!',
  ['license_weed'] = 'Marihuana-Verarbeitungslizenz',
  ['license_meth'] = 'Meth-Verarbeitungslizenz',
  ['need_license'] = 'Sie benötigen eine Lizenz, um dies zu nutzen.',
  ['licenseshop_title'] = 'Lizenz-Shop',
  ['licenseshop_prompt'] = 'Drücken sie ~INPUT_CONTEXT~ um den ~g~Lizenz-Shop~s~ zu öffnen.',
  ['license_bought'] = 'Sie haben ~b~1x~s~ ~y~%s~s~ für ~g~$%s~s~ gekauft',
  ['license_inventoryfull'] = 'Sie haben diese Lizenz bereits bei sich.',
  
  -- moneywash
  ['moneywash_washed'] = 'Du hast ~r~$%s~s~ Schwarzgeld gewaschen',
